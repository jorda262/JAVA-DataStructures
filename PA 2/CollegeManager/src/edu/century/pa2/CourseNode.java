...
public class CourseNode
{
   ...
   **/ 
   public static CourseNode listCopy(CourseNode source)
   {
      CourseNode copyHead;
      CourseNode copyTail;
      ...
      copyHead = new CourseNode(source.data, null);
      copyTail = copyHead;
   ...
   *   Indicates that there is insufficient memory for the new list.   
   **/
   public static CourseNode[ ] listCopyWithTail(CourseNode source)
   {
      CourseNode copyHead;
      CourseNode copyTail;
      CourseNode[ ] answer = new CourseNode[2];
   ...
   **/   
   public static int listLength(CourseNode head)
   {
      CourseNode cursor;
      int answer;
   ...
   *   Indicates that there is insufficient memory for the new list.    
   **/   
   public static CourseNode[ ] listPart(CourseNode start, CourseNode end)
   {
      CourseNode copyHead;
      CourseNode copyTail;
      CourseNode cursor;
      ...
      copyHead = new CourseNode(start.data, null);
      copyTail = copyHead;
      cursor = start;
   ...
   **/   
   public static CourseNode listPosition(CourseNode head, int position)
   {
      CourseNode cursor;
      int i;
   ...
   *   returned.     
   **/   
   public static CourseNode listSearch(CourseNode head, Course target)
   {
      CourseNode cursor;
